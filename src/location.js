export const Location = () => {
  return (<div>
    ...
    <select id="ethnicity" name="location" className="pl-4 relative w-full cursor-default rounded-md bg-white py-4 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6">
